...
```
### OUTPUT:
<img width="918" height="497" alt="image" src="https://github.com/user-attachments/assets/0ed84b01-3917-4d9d-8435-2a929e649512" />

### RESULT:
The prototype image-captioning application was successfully developed using the BLIP model and deployed through the Gradio interface, enabling accurate and real-time caption generation for uploaded images.
